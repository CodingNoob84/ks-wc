...
export const Info = () => {
  return (
    <div className="fixed bottom-24 right-8 z-50 rounded-full border w-10 h-10 flex justify-center items-center cursor-pointer animate-bounce">
      <Link href="/info" className="bg-white rounded-full">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="40"
          height="40"
          viewBox="0 0 50 50"
          className="border h-10 w-10 rounded-full text-red-700"
        >
          <path
            fill="currentColor"
